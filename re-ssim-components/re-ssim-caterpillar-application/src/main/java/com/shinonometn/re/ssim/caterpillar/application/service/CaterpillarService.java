...
public class CaterpillarService {
    ...
    private final Logger logger = LoggerFactory.getLogger(CaterpillarService.class);
    ...
    public CaterpillarService(CaterpillarFileManageService fileManageService,
     ...
     */
    @NotNull
    public Map<String, String> captureTermListFromRemote() {
     ...
     * @return task list
     */
    public Page<CaptureTaskDetails> listAllTasks(Pageable pageable) {
     ...
     * @return created task
     */
    public CaptureTask createByTermCode(String termCode) {
        CaptureTask captureTask = new CaptureTask();

        captureTask.setCreateDate(new Date());
        captureTask.setTermCode(termCode);
        captureTask.setTermName(captureTermListFromRemote().get(termCode));
     ...
     * @return task dto
     */
    public CaptureTaskDetails stopTaskById(String taskId) {
     ...
     * @return dto
     */
    public CaptureTaskDetails resumeTaskById(String taskId) {
        ...
        if (spiderStatus == null) throw new BusinessException("task_have_not_initialized");
        if (spiderStatus.getName().equals(Spider.Status.Running.name())) throw new BusinessException("spider_running");
     ...
     * @return dto
     */
    public CaptureTaskDetails startByTaskIdAndSettings(String taskId, CaterpillarSetting caterpillarSetting) {
    ...
    private void emitTaskCreateMessage() {
        // TODO
    }

    private void emitTaskFinishMessage() {
        // TODO
    }
...
//    }
    ...
    private void changeCaptureTaskStatus(CaptureTask captureTask, CaptureTaskStage status, String description) {
